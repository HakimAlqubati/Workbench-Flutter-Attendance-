...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    assert(() {
      // _emailCtrl.text = 'staff@admin.com';
      _emailCtrl.text = 'yahalattdi@att.com';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        // التعديل الأول: استخدام SafeArea و Stack رئيسي لترتيب العناصر
        child: SafeArea(
          child: Stack(
            children: [
              // 1. محتوى الصفحة بالكامل (البطاقة الزجاجية) في المنتصف
              Center(
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Semantics(
                                    label:
                                        'Copyright $currentYear NLT Workbench',
                                    child: Text(
              ...
              // 2. زر مسح الكاش تم نقله هنا ليكون أعلى يمين الشاشة وفوق كل شيء
              Positioned(
                top: 8,
                right: 16,
                child: IconButton(
                  icon: const Icon(
                    ...
                    color: Color(0xFF19E6C1),
                    size: 28, // تم تكبيرها قليلاً لسهولة الضغط
                  ),
                  onPressed: () => ClearCacheDialog.show(context),
                  tooltip: 'Clear Cache',
                ),
              ),
            ],
